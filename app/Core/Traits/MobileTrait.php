...
trait MobileTrait
{
    public function sendNotification(Post $post)
    {
        ...
        $fields = [
            ...
            'headings' => ['en' => ($this->authJWT()->can('isAdmin')) ? 'Admin Message :' : $post->title],
            'template_id' => '51c7c1bc-d53d-4a40-904e-6a9a2b7f2dfe',
            'contents' => ['en' => ($this->authJWT()->can('isAdmin')) ? 'Push Notification has been successfully sent ..' : $post->body],
            "included_segments" => ["All"],
